    ...
    @foreach ($data->heroSections as $heroSection)
        <div class="hero-section position-relative">
            ...
            <div class="container">
                <div class="row">
                    <div class="hero-left-section text-center">
                        ...
                        <p class="mb-3">Explore our budget-friendly dedicated server hosting, starting at $45/month. Choose
                            from unmanaged or managed bare metal with Free Control Panel, NVME SSDs, and Linux OS options.
                        </p>
                        ...
                        <div class="hero_feature">
                            <div class="feature1 d-flex"><img src="./assets/images/icons/Mulitple-Server-Locations.png"
                                    alt="Server Uptime" class="me-2">
                                <div class="text-start text-white feature_text">
                                    <h3>Free Sub Domain</h3>
                                    <small>(cu.ma, c1.is, thats.im etc)</small>
                                </div>
                            </div>
                            <div class="feature2 d-flex"><img src="./assets/images/icons/Mulitple-Server-Locations.png"
                                    alt="Server Uptime" class="me-2">
                                <div class="text-start text-white feature_text">
                            ...
                            <div class="feature3 d-flex"><img src="./assets/images/icons/Mulitple-Server-Locations.png"
                                    alt="Server Uptime" class="me-2">
                                <div class="text-start text-white feature_text">
                            ...
                            <div class="feature4 d-flex"><img src="./assets/images/icons/Mulitple-Server-Locations.png"
                                    alt="Server Uptime" class="me-2">
                                <div class="text-start text-white feature_text">
                        ...
                        <a href="" class="button_orange mt-4">Deploy Free Server now <i
                                class="fa-solid fa-angle-right ms-3"></i></a>
                        <div class="rated justify-content-center">
                            Starting at $45/mo
                        </div>
                    </div>
            ...
            <div class="inner container" style="padding-top: 0 !important;">
                <img loading="lazy" alt="featured on logos" class="img-fluid" data-cfsrc="depends/featured-logos2.png"
                    src="./assets/images/icons/featured-logos2.png">
            </div>
        </div>
    @endforeach
    <!-- / hero section -->
    ...
    <div class="features">
        ...
        <div class="container py-5 ">
            ...
            <p class=" text-center mx-auto p-3">
                Googiehost gives you most useful <strong>Web Hosting features</strong> that can help you to build your
                business or personal website with just few easy clicks. Get your business on Google, Yahoo & Bing today.
            </p>
            ...
            <div class="row g-4 mt-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center ">
                        ...
                        <div class="">
                            ...
                            <p class="card-text text-white p-md-3">We provide 100% Cloud Based super fast GoogieHostPanel <a
                                    href="">free web hosting</a> service for everyone across the globe. You'll also
                                get <strong> WordPress Manager</strong> to manage WordPress websites.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <div class="">
                            <p class="card-text text-white p-md-3">Create your website with an easy drag and drop option
                                without having special programming knowledge. Start building your online platform with <a
                                    href="">SitePad website Builder.</a> </p>
                            <a href="#" class="btn buttom-ffd700  w-100 fw-bold"><svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%" />
                                </svg>Know More <i class="fa-solid fa-angle-right"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <div class="">
                            ...
                            <p class="card-text text-white p-md-3">We provide the most effective and user-friendly cPanel
                                (Direct Admin). Free users get the most loved <span style="color: red;">♥</span> cPanel
                                preferred by industry-leading hosting platforms.</p>
                            <a href="#" class="btn buttom-ffd700  w-100 fw-bold"><svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%" />
                                </svg>Know More <i class="fa-solid fa-angle-right"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <div class="">
                            <p class="card-text text-white p-md-3">If you don't have your own domain name, you can use our
                                <a href="">free sub-domains</a> to create your instant website. Ex: yourname.cu.ma &
                                yourname.thats.im
                            </p>
                            <a href="#" class="btn buttom-ffd700  w-100 fw-bold"><svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%" />
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <div class="">
                            <p class="card-text text-white p-md-3">Install more than 380+ popular scripts with a single
                                click and get your website online in a few minutes using our Free <a href="">
                                    Softaculous Auto Installer option.</a></p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="text-center">
                        ...
                        <div class="">
                            <p class="card-text text-white p-md-3">We believe in 100% customer satisfaction. You can get
                                help from our <a href="">Knowledgebase</a> and Blog tutorial. For instant help, you
                                can also contact us via <a href="">email.</a> </p>
                            <a href="#" class="btn buttom-ffd700  w-100 fw-bold ">
                                <svg>
                                    <rect x="0" y="0" fill="none" width="100%" height="100%" />
                                </svg>Know More <i class="fa-solid fa-angle-right"></i></a>
            ...
            <div class="row w-100 align-items-center">
                <div class="d-flex align-items-center col-md-9">
                    ...
                    <div>
                        ...
                        <p class="text-white mb-0">
                            We believe in the growth of our clients business. So, we offer stunning performance with our
                            Free Hosting Plan. It doesn't end here. With free hosting, you also get free website builder,
                            Email accounts, support, and much more to kick start your website
                        </p>
                    </div>
                </div>
                <div class="col-md-3 text-md-right text-center mt-3 mt-md-0">
    ...
    <div class="cta">
        <div class="container">
            <div class="card col-12 col-md-8">
                ...
                <div class="pb-3">
                    <p class="intro px-3">
                        Follow the steps given below to create a free website. <a href="freehosting.html">GoogieHost offers
                            free hosting </a>to all of its users with no forced advertisements.
                    </p>
                    <ol class="list styled large mt-5">
                        <li><span>Fill in your credentials</span><br>
                            Order your free hosting account by <a class="biglink" href="signup.html">filling this Signup
                                form</a> with your basic details.
                        </li>
