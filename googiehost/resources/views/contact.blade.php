        ...
        <div class="container bg-white  contact-form-sec">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>Feel free to contact us any time. Please do not use this form if you have any free web
                        hosting-related queries, and We request you to go on our forum and create a topic to get instant
                        help from our expert support team, 24X7 support.</p><br>
                    <div class="quote-box">
