...
@section('content')
    <div class="pagetitle d-flex justify-content-between align-items-center">
        <div>
            <h1>Manage Dedicated Server Offers</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Admin</a></li>
                    <li class="breadcrumb-item active">Dedicated Server Offers</li>
                </ol>
            </nav>
        </div>
        <div>
            <a href="{{ route('offer.dedicated') }}" class="btn btn-primary">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            {{ isset($data->id) ? 'Update' : 'Create' }} Dedicated Server Offers
                        </h5>

                        <form class="row g-3" enctype="multipart/form-data" method="POST"
                            action="{{ isset($data->id) ? route('offer.dedicated.store', $data->id) : route('offer.dedicated.store') }}">
                            @csrf
                            ...
                            <div class="mb-3 col-12 col-lg-3 col-md-3">
                                <label for="number_rating" class="form-label">Number Rating</label>
                                <input type="text" class="form-control" name="number_rating" id="number_rating"
                                    value="{{ old('number_rating', $data->number_rating ?? '') }}">
                                @error('number_rating')
                                    <div class="message">{{ $message }}</div>
                                @enderror
                            </div>
