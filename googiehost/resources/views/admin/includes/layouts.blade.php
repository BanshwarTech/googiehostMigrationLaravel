        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Home Components</span><i
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="{{ route('admin.services-section') }}">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="{{ route('admin.vps-hosting-plans') }}">
                            <i class="bi bi-circle"></i><span>Vps Hosting</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.faq-section') }}">
