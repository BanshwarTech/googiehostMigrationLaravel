...
@section('content')
    <div class="pagetitle d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('manage.hero-section') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle"></i> Manage Hero Section
            </a>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                @foreach ($data as $index => $hero)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $hero->page->page_name }}</td>
                                        <td>{{ $hero->title }}</td>
                                        <td> <a href="{{ route('manage.hero-section', $hero->id) }}"
