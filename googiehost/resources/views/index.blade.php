...
@section('content')
    ...
    <div class="hero-section position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="hero-left-section text-center">
                    ...
                    <p class="mb-3">Our hosting services provide fast loading times, top-notch security, and dependable
                        uptime.</p>
                    <a href="" class="button_orange">START FOR FREE<i class="fa-solid fa-angle-right ms-3"></i></a>
        ...
        <div class="inner container" style="padding-top: 0 !important;">
            <img loading="lazy" alt="featured on logos" class="img-fluid" src="{{ asset('images/featured-logos2.png') }}">
        </div>
    </div>
